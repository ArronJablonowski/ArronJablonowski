...
*   **[birtha](https://github.com/ArronJablonowski/birtha):** A modular Bash framework for live incident response and threat hunting, built for systematic, repeatable investigations across macOS, Linux, and Unix systems.
...
*   **[Local Markdown Vault - VSCode Extension](https://github.com/ArronJablonowski/local-markdown-vault-vscode)** A secure, local-only VS Code extension with Obsidian-style live Markdown editing and document vault management.
